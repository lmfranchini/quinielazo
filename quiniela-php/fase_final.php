...
<body class="fade-in page-fase-final">
  ...
  <div class="top-bar">
    ...
    <a href="index.php?explicit=1" class="btn-admin" style="background: var(--fifa-purple)">⬅️ Fase de Grupos</a>
          ...
          <div style="padding-top: 1rem; border-top: 1px solid rgba(255,255,255,0.05); display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 1.5rem; font-size: 0.88rem; line-height: 1.5; color: var(--text-secondary);">
            <div>
              ...
              <ul style="list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 0.6rem;">
                ...
                <li style="display: flex; align-items: flex-start; gap: 0.5rem;">
                  <span style="font-size: 1.1rem; line-height: 1;">✗</span>
                  <div><strong>Fallo (0 pts):</strong> Si no se acierte el ganador (en los 120 mins o penales) ni la tendencia de empate.</div>
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul style="list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 0.6rem;">
                ...
                <li style="display: flex; align-items: flex-start; gap: 0.5rem;">
                  <span style="font-size: 1.1rem; line-height: 1;">🏆</span>
                  <div><strong>Ganador de la Quiniela:</strong> La quiniela abarca todo el certamen (104 partidos en total), por lo que el ganador definitivo se determinará al concluir la Gran Final del Mundial.</div>
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul style="list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 0.6rem;">
                ...
                <li style="display: flex; align-items: flex-start; gap: 0.5rem;">
                  <span style="font-size: 1.1rem; line-height: 1;">🏆</span>
                  <div><strong>Solo Gana el 1º Lugar:</strong> La bolsa acumulada se entregará únicamente al participante mejor posicionado que tenga la marca dorada ($). No hay premios para el 2º ni 3º lugar.</div>
                </li>
              </ul>
            </div>
          </div>
