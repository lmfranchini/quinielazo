...
$predStmt = $db->prepare("SELECT * FROM `" . PREDICTION_TABLE . "` WHERE userId = ?");
...
$users = $db->query("SELECT id, username, pointsFaseFinal AS points, hasPaidFaseFinal AS hasPaid FROM `User` WHERE role != 'ADMIN' AND hasJoinedFaseFinal = 1 ORDER BY id")->fetchAll();
